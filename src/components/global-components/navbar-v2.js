			...
			<div>
				...
				<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
					...
					<div className="row">
						...
						<div className="site-logo-wrap">
							...
							<Link to="/"><img src={publicUrl+"assets/img/Allmain/Logo (7).png"} alt="Logo"  style={{width:'120px'}}/></Link>
							</div>
				...
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<div className="site-logo">
						<Link to="/"><img src={publicUrl+"assets/img/Allmain/logo (7).png"} alt="Logo" style={{width:'90px'}} /></Link>
					</div>
					...
					<ul>
						...
						<li><a href="#" title="Twitter"><i className="fab fa-youtube" /></a></li>
