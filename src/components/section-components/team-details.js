...
class TeamDetails extends Component {
    ...
    return <div className="ltn__team-details-area mb-120">
                ...
                <h1 className="section-title" style={{textAlign:'center'}}>Our Team</h1>
                <div className="row">
                    ...
                    <div className="ltn__team-details-member-info text-center mb-40">
                        ...
                        <h2>Abdul Raaz  </h2>
                        <h6 className="text-uppercase ltn__secondary-color">Co-Founder &  Architect</h6>
                    ...
                    <div className="col-lg-5" style={{textAlign:'justify',textJustify:'inter-word',marginTop:'40px'}}>
                    <div className="ltn__team-details-member-info-details">
                        <p>our dynamic creative force infusing boundless energy into our corporation. With a personality that bounces with enthusiasm, Raaz sees stories in every moment. Specializing in conceptualization, he effortlessly weaves ideas. His love for stories extends to capturing moments and creating photographs which are visual tales . Join us, where every concept and image is a celebration of creativity and storytelling.</p>
