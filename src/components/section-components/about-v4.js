    ...
    return  <div className="ltn__about-us-area pt-120--- pb-90 mt--30 go-top">
				...
				<div className="row">
					...
					<div className="about-us-info-wrap">
						...
						<h1 className="section-title" style={{fontSize:'30px'}}>Live in the now, design for the future. We Design  spaces that seamlessly adapt as your life evolves<span>.</span></h1>
						...
						<Link to="/service" className="theme-btn-1 btn btn-effect-1">OUR Projects </Link>
						</div>
					</div>
					</div>
				</div>
